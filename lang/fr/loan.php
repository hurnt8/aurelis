...
return [
    ...
    'service_benefits_title' => 'Pourquoi choisir cette offre',
    'service_related_title'  => 'Découvrez aussi nos autres solutions',
    'service_related_sub'    => 'Un autre projet en tête ? Nous avons sûrement la formule qu\'il vous faut.',
    ...
    'general_faqs' => [
        'question1' => 'Quel est le taux d\'intérêt appliqué à mon prêt ?',
        'answer1' => 'Le taux dépend du montant emprunté, de la durée choisie et de votre profil (revenus, situation professionnelle, historique de crédit). Après simulation, vous recevez une offre personnalisée avant tout engagement, sans frais ni impact sur votre dossier.',
        'question2' => 'Quel est le montant maximum que je peux emprunter ?',
        'answer2' => 'Selon le type de prêt et votre capacité de remboursement, ' . site_name() . ' finance des projets jusqu\'à 5 000 000 € (ou l\'équivalent dans votre devise). Le montant exact proposé dépend de l\'étude de votre dossier.',
        'question3' => 'À quoi puis-je utiliser mon prêt ?',
        'answer3' => 'Vous décidez librement de l\'usage de votre prêt personnel : achat, travaux, voyage, imprévu... Pour un projet précis (immobilier, auto, études, entreprise), nos offres dédiées proposent des conditions mieux adaptées : n\'hésitez pas à comparer nos différents produits.',
        'question4' => 'Qui peut demander un prêt chez ' . site_name() . ' ?',
        'answer4' => 'Toute personne majeure disposant d\'un revenu régulier et d\'une pièce d\'identité valide peut déposer une demande en ligne. L\'octroi final dépend de l\'analyse de votre situation financière et de votre capacité de remboursement.',
        'question5' => 'Combien de temps avant de recevoir les fonds ?',
        'answer5' => 'Une fois votre dossier validé et le contrat signé électroniquement, les fonds sont généralement virés sur votre compte sous 48 heures ouvrées.',
        'question6' => 'Puis-je effectuer des remboursements anticipés ?',
        'answer6' => 'Oui, vous pouvez rembourser tout ou partie de votre prêt par anticipation à tout moment, sans frais cachés. Un remboursement anticipé réduit la durée restante ou le montant des mensualités suivantes.',
        'question7' => 'Puis-je solder mon prêt avant la fin prévue du contrat ?',
        'answer7' => 'Oui, le remboursement total anticipé est possible à tout moment sur simple demande. Contactez notre service client pour obtenir le solde exact à rembourser à la date de votre choix.',
        'question8' => 'Quels documents dois-je fournir pour ma demande en ligne ?',
        'answer8' => 'Une pièce d\'identité valide, un justificatif de revenus et, selon le type de prêt, quelques documents complémentaires (justificatif de domicile, relevé bancaire...). La liste précise vous est communiquée après la simulation.',
        'question9' => 'Comment transmettre mes documents lors d\'une demande en ligne ?',
        'answer9' => 'Vous téléversez directement vos documents (PDF, JPEG ou PNG) depuis l\'espace de demande en ligne, en toute sécurité. Aucun envoi postal ni déplacement en agence n\'est nécessaire.',
        'question10' => 'Le taux annoncé inclut-il tous les frais ?',
        'answer10' => 'Vos mensualités couvrent le capital emprunté et les intérêts. Aucun frais supplémentaire ne s\'applique en cours de prêt, sauf assurance facultative que vous auriez souscrite.',
        'question11' => 'Puis-je emprunter si j\'ai déjà un crédit en cours ailleurs ?',
        'answer11' => 'Un crédit existant n\'empêche pas automatiquement l\'octroi d\'un nouveau prêt : ce qui compte, c\'est votre capacité à assumer l\'ensemble de vos mensualités. Un rachat de crédits peut aussi être envisagé pour simplifier votre budget.',
        'question12' => 'Puis-je avoir plusieurs prêts en cours chez ' . site_name() . ' ?',
        'answer12' => 'Oui, sous réserve d\'un revenu net disponible suffisant et d\'une bonne tenue de vos comptes. Chaque nouvelle demande fait l\'objet d\'une étude indépendante de votre situation globale.',
        'question13' => 'Que se passe-t-il si je ne peux plus payer une mensualité ?',
        'answer13' => 'Contactez notre service client dès que possible : un report d\'échéance ou un réaménagement de votre prêt peut être étudié. Plus l\'échange est précoce, plus les solutions sont nombreuses.',
        'question14' => 'Puis-je assurer mon prêt ?',
        'answer14' => 'Une assurance emprunteur facultative peut couvrir vos mensualités en cas de perte d\'emploi, d\'incapacité ou de décès, pour protéger votre famille. Elle n\'est pas obligatoire pour l\'obtention du prêt et peut être ajoutée à tout moment.',
    ],
