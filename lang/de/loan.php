...
return [
    ...
    'service_benefits_title' => 'Warum dieses Angebot wählen',
    'service_related_title'  => 'Entdecken Sie auch unsere weiteren Lösungen',
    'service_related_sub'    => 'Haben Sie ein anderes Vorhaben? Wir haben sicher die passende Lösung für Sie.',
    ...
    'general_faqs' => [
        'question1' => 'Welcher Zinssatz gilt für meinen Kredit?',
        'answer1' => 'Der Zinssatz hängt vom geliehenen Betrag, der gewählten Laufzeit und Ihrem Profil ab (Einkommen, berufliche Situation, Kredithistorie). Nach der Simulation erhalten Sie ein individuelles Angebot vor jeder Verpflichtung, kostenlos und ohne Auswirkung auf Ihre Bonität.',
        'question2' => 'Wie hoch ist der maximale Betrag, den ich leihen kann?',
        'answer2' => 'Je nach Kreditart und Ihrer Rückzahlungsfähigkeit finanziert ' . site_name() . ' Projekte bis zu 5.000.000 € (oder dem Gegenwert in Ihrer Währung). Der genaue angebotene Betrag hängt von der Prüfung Ihres Antrags ab.',
        'question3' => 'Wofür kann ich meinen Kredit verwenden?',
        'answer3' => 'Sie entscheiden frei über die Verwendung Ihres Privatkredits: Anschaffung, Renovierung, Reise, unvorhergesehene Ausgaben... Für ein konkretes Vorhaben (Immobilie, Auto, Studium, Unternehmen) bieten unsere spezialisierten Angebote besser angepasste Konditionen: Vergleichen Sie gerne unsere verschiedenen Produkte.',
        'question4' => 'Wer kann bei ' . site_name() . ' einen Kredit beantragen?',
        'answer4' => 'Jede volljährige Person mit regelmäßigem Einkommen und einem gültigen Ausweisdokument kann online einen Antrag stellen. Die endgültige Bewilligung hängt von der Analyse Ihrer finanziellen Situation und Ihrer Rückzahlungsfähigkeit ab.',
        'question5' => 'Wie lange dauert es, bis ich das Geld erhalte?',
        'answer5' => 'Sobald Ihr Antrag genehmigt und der Vertrag elektronisch unterzeichnet ist, wird der Betrag in der Regel innerhalb von 48 Werkstunden auf Ihr Konto überwiesen.',
        'question6' => 'Kann ich vorzeitige Rückzahlungen leisten?',
        'answer6' => 'Ja, Sie können Ihren Kredit jederzeit ganz oder teilweise vorzeitig zurückzahlen, ohne versteckte Gebühren. Eine vorzeitige Rückzahlung verkürzt die verbleibende Laufzeit oder reduziert die folgenden Raten.',
        'question7' => 'Kann ich meinen Kredit vor Vertragsende vollständig ablösen?',
        'answer7' => 'Ja, die vollständige vorzeitige Rückzahlung ist jederzeit auf einfache Anfrage möglich. Kontaktieren Sie unseren Kundenservice, um den genauen Restbetrag zum gewünschten Datum zu erfahren.',
        'question8' => 'Welche Unterlagen muss ich für meinen Online-Antrag einreichen?',
        'answer8' => 'Ein gültiges Ausweisdokument, einen Einkommensnachweis und je nach Kreditart einige zusätzliche Unterlagen (Wohnsitznachweis, Kontoauszug...). Die genaue Liste erhalten Sie nach der Simulation.',
        'question9' => 'Wie übermittle ich meine Unterlagen bei einem Online-Antrag?',
        'answer9' => 'Sie laden Ihre Dokumente (PDF, JPEG oder PNG) direkt und sicher über den Online-Antragsbereich hoch. Kein Postversand oder Besuch in einer Filiale erforderlich.',
        'question10' => 'Sind im angegebenen Zinssatz alle Kosten enthalten?',
        'answer10' => 'Ihre Raten decken das geliehene Kapital und die Zinsen. Während der Kreditlaufzeit fallen keine zusätzlichen Gebühren an, außer einer eventuell abgeschlossenen freiwilligen Versicherung.',
        'question11' => 'Kann ich einen Kredit aufnehmen, wenn ich bereits einen laufenden Kredit anderswo habe?',
        'answer11' => 'Ein bestehender Kredit schließt die Bewilligung eines neuen Kredits nicht automatisch aus: Entscheidend ist Ihre Fähigkeit, alle Ihre Raten zu tragen. Eine Umschuldung kann ebenfalls in Betracht gezogen werden, um Ihr Budget zu vereinfachen.',
        'question12' => 'Kann ich mehrere Kredite gleichzeitig bei ' . site_name() . ' haben?',
        'answer12' => 'Ja, sofern ein ausreichendes verfügbares Nettoeinkommen und eine gute Kontoführung vorliegen. Jeder neue Antrag wird unabhängig anhand Ihrer Gesamtsituation geprüft.',
        'question13' => 'Was passiert, wenn ich eine Rate nicht mehr zahlen kann?',
        'answer13' => 'Kontaktieren Sie unseren Kundenservice so früh wie möglich: Eine Zahlungsverschiebung oder eine Umstrukturierung Ihres Kredits kann geprüft werden. Je früher Sie sich melden, desto mehr Lösungen stehen zur Verfügung.',
        'question14' => 'Kann ich meinen Kredit versichern?',
        'answer14' => 'Eine freiwillige Kreditversicherung kann Ihre Raten im Falle von Arbeitsverlust, Erwerbsunfähigkeit oder Tod abdecken, um Ihre Familie zu schützen. Sie ist für die Kreditvergabe nicht verpflichtend und kann jederzeit hinzugefügt werden.',
    ],
