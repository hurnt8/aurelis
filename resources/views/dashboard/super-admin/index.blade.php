...
.sadb-hero::before {
  ...
  background: radial-gradient(circle, rgba(38, 130, 38,.12) 0%, transparent 70%);
  pointer-events: none;
}
.sadb-hero::after {
  content: '';
...
.sadb-hero-tag {
  ...
  background: rgba(38, 130, 38,.12); border: 1px solid rgba(38, 130, 38,.2);
...
/* icon colors */
.sadb-ico-navy { background: rgba(42, 25, 103,.08); color: var(--c-navy); }
.sadb-ico-accent { background: rgba(38, 130, 38,.12); color: #a07d20; }
...
.sadb-pwa-btn {
  ...
  border: 1px solid rgba(38, 130, 38,.35);
  border-radius: 8px;
  background: rgba(38, 130, 38,.1);
  color: var(--c-accent);
  font-size: .7rem; font-weight: 600;
  cursor: pointer; font-family: inherit;
  transition: background .2s, border-color .2s;
}
.sadb-pwa-btn:hover { background: rgba(38, 130, 38,.22); border-color: rgba(38, 130, 38,.6); }
...
@php
  ...
  $avatarPalette = ['#2563EB','#059669','#D97706','#7C3AED','#DC2626','#0D9488','#268226'];
...
<div class="sadb-hero">
  <div class="sadb-hero-left">
    ...
    <div class="sadb-hero-users">
      ...
      <span class="sadb-user-chip" style="background:rgba(38, 130, 38,.15);color:var(--c-accent)">
...
<div class="sadb-kpi-grid">
  ...
  <div class="sadb-kpi">
    <div class="sadb-kpi-top">
      ...
      <span style="font-size:.65rem;font-weight:700;background:rgba(38, 130, 38,.1);color:#a07d20;padding:.18rem .45rem;border-radius:999px">
    ...
    <div class="sadb-card-body">
      ...
      <div class="sadb-ring-wrap">
        <svg width="110" height="110" viewBox="0 0 120 120" style="flex-shrink:0">
          ...
          @endif
          @endforeach
          <text x="{{ $cx }}" y="{{ $cy - 3 }}" text-anchor="middle" font-size="15" font-weight="800" fill="#2A1967">{{ $stats['total_loans'] }}</text>
