...
/* ── Hero ── */
.adb-hero {
  background: linear-gradient(135deg, #2A1967 0%, #3A2A72 60%, #3A2A72 100%);
  border-radius: 16px;
...
.adb-hero::before {
  ...
  background: rgba(38, 130, 38,.06); pointer-events: none;
}
.adb-hero::after {
  content: '';
  position: absolute; bottom: -70px; right: 100px;
  width: 180px; height: 180px; border-radius: 50%;
  background: rgba(38, 130, 38,.04); pointer-events: none;
}
...
/* Colors */
.adb-ico-navy { background: rgba(42, 25, 103,.08); color: var(--c-navy); }
.adb-ico-accent { background: rgba(38, 130, 38,.12); color: #a07d20; }
...
.adb-pwa-btn:hover { background: rgba(38, 130, 38,.22); border-color: rgba(38, 130, 38,.6); }
...
<div class="adb-kpi-grid">
  ...
  <div class="adb-kpi">
    <div class="adb-kpi-top">
      ...
      <span class="adb-kpi-change" style="background:rgba(38, 130, 38,.12);color:#a07d20">
