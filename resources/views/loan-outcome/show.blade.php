...
.hdr{background:#2A1967;padding:36px 40px;text-align:center}
...
.step-num{flex-shrink:0;width:28px;height:28px;border-radius:50%;background:#2A1967;color:#DEC066;font-size:.8rem;font-weight:800;display:flex;align-items:center;justify-content:center}
...
.contact-btn{display:inline-block;padding:10px 26px;border-radius:8px;font-size:.88rem;font-weight:700;text-decoration:none;color:#ffffff;background:#2A1967}
