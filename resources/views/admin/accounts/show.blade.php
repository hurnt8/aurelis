...
/* ── Hero card ── */
.acs-hero{background:linear-gradient(135deg,#1A1040 0%,#110A29 100%);border-radius:var(--radius-md);padding:2rem 2.25rem;color:#fff;display:grid;grid-template-columns:auto 1fr auto;gap:1.75rem;align-items:center;margin-bottom:1.75rem}
...
.acs-op:hover{border-color:rgba(38, 130, 38,.35)}
...
.acs-field input:focus,.acs-field textarea:focus{border-color:var(--c-accent);box-shadow:0 0 0 3px rgba(38, 130, 38,.1)}
...
.acs-mvt:hover{border-color:rgba(38, 130, 38,.3)}
