...
.ld-avatar{width:48px;height:48px;border-radius:12px;background:linear-gradient(135deg,var(--c-navy),#150D34);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1.1rem;color:var(--c-accent);flex-shrink:0}
...
.ld-step.is-current .ld-step-dot{background:var(--c-accent);border-color:var(--c-accent);color:var(--c-navy);box-shadow:0 0 0 5px rgba(38, 130, 38,.15)}
...
.ld-tab-btn.active .ld-tab-badge{background:rgba(38, 130, 38,.15);color:var(--c-accent-d,#443579)}
...
<div class="ld-kpi-strip">
  <div class="ld-kpi">
    <div class="ld-kpi-ico" style="background:#FEF9EC;color:var(--c-accent-d,#443579)">
