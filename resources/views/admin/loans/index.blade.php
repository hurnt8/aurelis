...
.li-search-input:focus{border-color:var(--c-accent);background:#fff;box-shadow:0 0 0 3px rgba(38, 130, 38,.1)}
...
.li-avatar--client{background:linear-gradient(135deg,var(--c-navy),#150D34);color:var(--c-accent)}
