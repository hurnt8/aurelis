...
/* ── Header ── */
.hdr{background:#2A1967;padding:28px 44px;text-align:center}
...
.body a{color:#268226}
.body h1,.body h2,.body h3{color:#2A1967;margin:0 0 .75rem}
/* ── Info panel ── */
...
.alert-info   {background:#FBF7EE;border:1px solid #EEE1C3;border-left:3px solid #268226;color:#5A4A25}
...
.url-fallback a{color:#268226;text-decoration:none}
/* ── Closing ── */
...
.footer a{color:#268226;text-decoration:none}
