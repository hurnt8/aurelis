...
@php
  ...
  $donutColors = ['rgba(27,138,122,.75)', 'rgba(101, 220, 80,.75)', 'rgba(255,90,90,.75)', 'rgba(74,222,128,.65)'];
...
<div x-data="{ period: 'month' }" style="margin-top:.75rem">
  ...
  <div class="ca-txn-list">
    ...
    <div class="ca-category-item">
      <div class="ca-category-icon" style="background:rgba(101, 220, 80,.15);color:var(--ca-accent-l)">
